...
<body>
    ...
    <div class="full-height">
        ...
        <table border="0">
            <tr>
                <td width="80%">
                    <font class="edoc-logo">Medical appointment. </font>

                </td>
                <td width="10%">
                   <a href="login"  class="non-style-link"><p class="nav-item">LOGIN</p></a>
                </td>
                <td  width="10%">
                    <a href="signup" class="non-style-link"><p class="nav-item" style="padding-right: 10px;">REGISTER</p></a>
                </td>
            </tr>
        ...
        <p class="sub-text2 footer-hashen">Appointment</p>
    </center>
