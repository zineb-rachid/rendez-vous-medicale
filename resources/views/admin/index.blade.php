                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    <p style="padding: 0 0 0 5px;font-size: 14px;font-weight: 600;color: rgba(0, 0, 0, 0.452);">Here is the list of upcoming sessions until 7 days</p>
                                </td>
                                <td>
                                    <p style="text-align: right;padding: 0 20px 0 0;">
                                        <a href="{{ route('admin_appointments') }}" class="non-style-link"><button class="login-btn btn-primary btn" style="padding: 10px 25px;">Show all</button></a>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    <center>
                                        <div class="abc scroll" style="height: 100px;">
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    <p style="padding: 0 0 0 5px;font-size: 14px;font-weight: 600;color: rgba(0, 0, 0, 0.452);">Here is the list of upcoming sessions that are scheduled within 7 days</p>
                                </td>
                                <td>
                                    <p style="text-align: right;padding: 0 20px 0 0;">
                                        <a href="{{ route('admin_schedule') }}" class="non-style-link"><button class="login-btn btn-primary btn" style="padding: 10px 25px;">Show all</button></a>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                ...
                                                                <center>
                                                                    <img src="{{ asset('img/notfound.svg') }}" width="25%">
                                                                    <p class="heading-main12" style="margin-top: 20px;font-size: 20px;color: #ff5050;">Nothing to show here!</p>
                                                                    <a class="non-style-link" href="{{ route('admin_schedule') }}"><button class="login-btn btn-primary-soft btn">Show all Sessions</button></a>
                                                                </center>
                                                                <br><br><br><br>
                                                            </td>
                                                        </tr>
