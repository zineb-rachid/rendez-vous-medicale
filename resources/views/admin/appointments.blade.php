            ...
            <table border="0" width="100%" style="border-spacing: 0; margin: 0; padding: 0; margin-top: 25px;">
                ...
                <td colspan="4">
                    ...
                    @foreach($appointments as $appointments)
                        <tr>
                         <td>  {{ $appointments->patient->pname }}</td>
                            <td style="text-align: center; font-size: 23px; font-weight: 500; color: var(--btnnicetext);">
                                {{ $appointments->appnum }}
                            </td>
                            <td>{{$appointments->schedule->doctor->docname}}</td>
                            <td>{{ Str::limit($appointments->schedule->title, 15) }}</td>
                            <td style="text-align: center; font-size: 12px;">
                                {{ $appointments->schedule->scheduledate }} <br> {{ $appointments->schedule->scheduletime }}
                            </td>
                            ...
                            <td>
                                <div style="display: flex; justify-content: center;">
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <a href="{{ route('appointments.delete', ['id' => $appointments->appid]) }}" class="non-style-link">
